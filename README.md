...
* `git clone git@github.com:rumblex/angularattack2016-ngrobot.git`

* `cd angularattack2016-ngrobot`
...
If you receive an error message `"You do not have permission to publish to ngrobot.2016.angularattack.io"`, it might mean another team member has already deployed your project to Surge. Ask them to run the next step to give you access.

### Step 3) Add Your Team Members to Surge

* `surge . --add jmanuelgarciagarcia@gmail.com,fer.martyni@gmail.com,damzeloca@gmail.com,ardiadrianadri@gmail.com`
